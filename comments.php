...
<?php if ( have_comments() ) : ?>
	<h2 class="comments"><?php comments_number('no comments?!', '1 comment!', '% comments!!!' );?></h2>
...
<small>You must be <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php echo urlencode(get_permalink()); ?>">logged in</a> to post a comment.</small>
<?php else : ?>
